            ...
            <div className="tf-product-info-list">
              <div className="tf-product-info-heading">
                <div className="tf-product-info-name">
                  ...
                  <h3 className="name text-primary">{quickViewItem.name}</h3>
                  <div className="sub">
                    <div className="tf-product-info-rate">
                        ...
                        {Array.from({ length: 5 }, (_, index) => (
                          <i
                            ...
                            className={`icon icon-star ${
                              index <
                              Math.round(quickViewItem.ratings?.average || 0)
                                ? "filled"
                                : ""
                            }`}
                          />
                      ...
                      <div className="text text-caption-1 text-primary">
                        ({quickViewItem.ratings?.reviews?.length || 0} reviews)
                      </div>
                    </div>
                ...
                <div className="tf-product-info-desc">
                  ...
                  <p className="text-black">{quickViewItem.shortDescription}</p>
                  ...
                  <div className="tf-quickViewItem-info-by-btn mb_10">
                    <a
                      ...
                      onClick={() => {
                        ...
                        } else if (quickViewItem.productType === "variant") {
                          if (activeSize) {
