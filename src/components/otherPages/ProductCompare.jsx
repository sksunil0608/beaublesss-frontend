          ...
          <div className="tf-compare-table">
                    ...
                    <div className="tf-compare-content">
                      ...
                      <p className="desc text-caption-1">
                        <span>
                          {categories.find(
                            (category) =>
                              category._id?.toString() === elm.category
            ...
            <div className="tf-compare-row">
              ...
              {items.map((elm, i) => (
                ...
                >
                  <span className="price">₹{elm.offerPrice.toFixed(2)}</span>
                </div>
              ))}
            </div>
            <div className="tf-compare-row">
              ...
              {items.map((elm, i) => (
                <div
                  ...
                  className="tf-compare-col tf-compare-field text-center"
                >
                  <span className="type">{elm.productType}</span>
                </div>
              ))}
            </div>
            <div className="tf-compare-row">
              ...
              {items.map((elm, i) => (
                <div
                  ...
                  className="tf-compare-col tf-compare-field text-center"
                >
                  <span className="brand">Buebless</span>
                </div>
              ))}
            </div>
            <div className="tf-compare-row">
