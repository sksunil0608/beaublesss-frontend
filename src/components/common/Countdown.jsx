...
const CountdownTimer = ({ style = 1, targetDate = "2025-03-15T23:59:59" }) => {
          ...
          {style == 2 ? (
            <div aria-hidden="true" className="countdown__timer">
              <span className="countdown__item">
                ...
                <span className="countdown__label text-primary">Days</span>
              </span>
              <span className="countdown__item">
                <span className="countdown__value countdown__value--1 js-countdown__value--1">
                  {timeLeft.hours}
                </span>
                <span className="countdown__label text-primary">Hours</span>
              </span>
              <span className="countdown__item">
                <span className="countdown__value countdown__value--2 js-countdown__value--2">
                  {timeLeft.minutes}
                </span>
                <span className="countdown__label text-primary">Mins</span>
              </span>
              <span className="countdown__item">
                <span className="countdown__value countdown__value--3 js-countdown__value--3">
                  {timeLeft.seconds}
                </span>
                <span className="countdown__label text-primary">Secs</span>
              </span>
            </div>
          ) : (
            ""
