...
import Slider1 from "../sliders/Slider4";
...
export default function Details1({ product }) {
  ...
  const filterSizes = product.variants || [];
  const {
    addProductToCart,
  ...
  const matchedCategory = categories.find((category) => {
    return category._id?.toString() === product.category;
  });
  return (
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="tf-product-media-wrap sticky-top">
                <Slider1
                  activeVarient={product?.variants[0] || "30ml"}
                  setActiveVarient={() => {}}
                    ...
                    <div className="tf-product-info-desc">
                      ...
                      <div className="tf-product-info-choose-option">
                        <div className="tf-product-with-discount">
                          {/* <p className="mb_12">Usable discount codes:</p> */}
                          <div className="tf-product-discount-list">
                            {coupons.length > 0 &&
                              coupons.map((item, index) => (
                                <div
                                  key={item.id || index}
                                  className="tf-product-discount-item"
                                >
                                  <svg
                                    width={130}
                                    height={32}
                        ...
                        <div className="tf-product-info-by-btn mb_10">
                          ...
                          <a
                            ...
                            className="btn-style-2 flex-grow-1 text-btn-uppercase fw-6 btn-add-to-cart btn-sm"
                          >
                            <span>
                              {isAddedToCartProducts(product._id)
                                ? "Added"
