          ...
          <div className="widget-facet facet-categories">
            ...
            <ul className="facet-content">
              {categories.map((category, index) => (
                <li key={index}>
                  <a
                    href={`/collections/${category.slug || "products"}`}
            ...
            <div className="facet-size-box size-box">
              ...
              <span
                className={`size-item size-check free-size ${
                  allProps.size == "Default" ? "active" : ""
                } `}
                onClick={() => allProps.setSize("Default")}
              >
                Default
              </span>
            </div>
              ...
              {availabilityOptions.map((option, index) => (
                ...
                >
                  <input
                    ...
                    className="tf-check"
                    readOnly
                    checked={allProps.availability?.id === option.id}
                  />
                  <label>
                    {option.label}{" "}
                    <span className="count-stock">({option.count})</span>
                  </label>
                </fieldset>
              ))}
            </div>
