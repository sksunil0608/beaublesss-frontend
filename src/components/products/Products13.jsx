    ...
    <>
      <section className="flat-spacing">
        <div className="container">
          <div className="tf-shop-control wrapper-filter-dropdown">
            <div className="tf-control-filter">
              <button
                id="filterDropdown"
                onClick={() => setIsDDActive((pre) => !pre)}
                className={`tf-btn-filter ${isDDActive ? "active" : ""} `}
              >
                <span
                  className={`icon icon-${isDDActive ? "close" : "filter"}`}
                />
            ...
            <div
              className={`dropdown-filter sidebar-filter left canvas-filter ${
                isDDActive ? "show" : ""
              } `}
            >
              <DropdownFilter
